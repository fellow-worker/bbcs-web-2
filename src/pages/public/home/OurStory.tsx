...
const OurStory = () => (
  <>
    ...
    <TextBlock>
      ...
      <Paragraph justify>
        De focus bij deze cursussen ligt op het kennen van Christus als onze Verlosser, maar wil
        ons ook helpen om Hem na te volgen als onze Meester. Weet jij een goed boek of cursus
        waarin het niet gaat om mij, mijn kerk, mijn leer, maar om het kennen en navolgen van
        Christus (Filippi 3:8)? Neem dan contact op met info@bijbelcursussen.nl zodat we kunnen
        kijken of deze cursus ook op de site geplaatst kan worden.
      </Paragraph>
    </TextBlock>
  </>
);
